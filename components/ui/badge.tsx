  ...
  "inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1",
  {
    variants: {
      variant: {
        ...
        news:
          "border-transparent bg-blue-500/15 text-blue-500 dark:bg-blue-500/15 dark:text-blue-400",
        curious:
          "border-transparent bg-violet-500/15 text-violet-600 dark:bg-violet-500/15 dark:text-violet-400",
        category:
